...
### 📌 Easy_AIInfra — 训练/推理优化（34 题）
训练：梯度累积 / AMP / DDP+RingAllReduce / ZeRO / 张量并行 / 1F1B流水 / 激活重计算 / FSDP / Hybrid Shard / CPU Offload / ZeRO++
推理：KV Cache / PagedAttention / FlashAttention / ContBatching / vLLM调度 / 投机解码 / Eagle / Medusa / 自投机
量化：W8A16 / AWQ·GPTQ / SmoothQuant / 对称vs非对称 / Per-channel vs Per-token
稀疏：2:4结构化 / Wanda / SparseGPT
进阶：MoE all-to-all / 多LoRA / DistServe / 动态Rollout / 序列并行 / Interleaved PP / Fused Kernels
