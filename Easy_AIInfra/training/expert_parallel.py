...
class ExpertParallelMoE(nn.Module):
    ...
    def __init__(self, dim, n_experts, n_local_experts, top_k=2):
        super().__init__()
        self.dim = dim
    ...
    def all_to_all_combine(self, outputs, x_shape, weights, indices):
    ...
    def auxiliary_loss(self, x, alpha=0.01):
        """负载均衡 auxiliary loss"""
        logits = self.gate(x)
